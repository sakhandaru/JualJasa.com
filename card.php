<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        $conn -> query("INSERT INTO `db_keranjang`(`produk_name`, `deskripsi`, `jumlah`, `url`, `image`, `harga`) 
        VALUES ('$produk','$deskripsi','$jumlah','$url','$file','$harga')");
            ...
            <div class="kanan">
                <div class="isikanan">
                    <form action=" " class="form" style="color: white;" method="post">
                        ...
                        <input type="text" id="deskripsikan" name="deskripsi" placeholder="Tuliskan keinginanmu"><br><br>
