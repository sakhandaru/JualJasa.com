...
<body>
	...
	<div class="badan" id="home">
		...
		<div class="content">
			<h4>Hello, welcome <?php echo $_SESSION['a_global']->admin_name ?></h4>
			<h1>The_<span>Website.</span></h1>
			<h3>Jadikan hobimu uang!</h3>
		</div>
		...
		<div>
				<div class="about">
						<center>
							...
							<button class="home"><a href="#home"><p class="home3">home</p></a></button>
						</center>
				</div>
		</div>
	<!-- </center> -->
